...
Este repositório contém aplicações do "Clean Architecture" - do Uncle Bob - no Flutter. Foi criado com base no esquema proposto pela comunidade do [Flutterando](https://github.com/Flutterando/Clean-Dart).
